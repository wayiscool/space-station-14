...
public sealed class MaterialArbitrageTest : GameTest
{
    ...
    private readonly HashSet<string> _compositionArbitrageIgnore = ["SwordFlaming"]; // Starlight, the recipe consumes a forged sword through a tag step the material-only check cannot price
