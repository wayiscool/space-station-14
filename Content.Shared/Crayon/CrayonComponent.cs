...
public sealed class CrayonBoundUserInterfaceState : BoundUserInterfaceState
{
    ...
    public CrayonBoundUserInterfaceState(string selected, bool selectableColor, Color color, float rotation, bool previewEnabled, bool previewVisible, bool opaqueGhost) // Starlight-edit - add parameters
    {
        Selected = selected;
